...
平台采用“一个代码仓库＋一个共享底座＋四个独立网站”的产品结构：客户可以只购买和使用当前最需要的网站，也可以逐步形成从可信数据、优化决策到收益验证的完整闭环。
...
四个网站分别拥有独立应用入口和部署网址，共享字段映射、数据版本、指标口径、SLA约束和审计证据。共享底座只实现一次，不在四个网站中复制。
...
- [四站平台正式规格](docs/superpowers/specs/2026-09-10-four-site-platform-design.md)
